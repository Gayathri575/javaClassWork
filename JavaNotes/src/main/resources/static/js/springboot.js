...
async function fetchNotes() {
    pageContent.innerHTML = `<div class="loader">Fetching Spring Boot notes from Database...</div>`;
    ...
    try {
        ...
        if (sorted.length > 0) {
            ...
            pageContent.innerHTML = `<h3>No Spring Boot content found in database.</h3>`;
