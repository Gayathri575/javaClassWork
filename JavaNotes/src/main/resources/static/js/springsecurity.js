...
const springSecurityCategories = [
    "Authentication", "Authorization", "User Management",
    "Configuration", "Token & Session", "OAuth2 & Advanced",
    "Filters & Chain", "Method Security", "Exception & Logout"
];
...
async function fetchNotes() {
    pageContent.innerHTML = `<div class="loader">Fetching Spring Security from Database...</div>`;
    ...
    try {
        ...
        if (sorted.length > 0) {
            ...
            pageContent.innerHTML = `<h3>No Spring Security content found in database.</h3>`;
